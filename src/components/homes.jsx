...
const Home = () => {
  ...
  return (
    <div className="w-full max-w-[660px] border-x border-gray-700 min-h-screen bg-black">
      {/* Header Tabs */}
        ...
        <div className="w-full">
          ...
          <div className="flex justify-between items-center mt-3">
           ...
           {/* CALENDER ICON */}
            ...
            {/* Post Button */}
            <button className="bg-blue-500 text-white px-4 py-2 rounded-full font-medium">
              Post
            </button>
          </div>
        </div>
